            ...
            <Grid container direction='row' justifyContent='center' alignContent='center' className="container-sobrenos">
                ...
                <Grid item xs={12} sm={4}>
                    <Box className="box-txt">
                        <Typography align="center" className="txt-home1">No projeto integrador da Generation Brasil nos foi proposto o desafio desenvolver uma solução (site ou e-commerce) para o "Objetivo 3" dos 17 ODS (Objetivos de Desenvolvimento Sustentável) da ONU.</Typography>
                        <Typography align="center" className="txt-home1">O desafio do ODS3 é:</Typography>
                        <Typography align="center" className="txt-home1">"Como será que podemos contribuir para garantir o acesso a saúde de qualidade e/ou promover o bem-estar para todos, em todas as idades, em sua comunidade, cidade ou país?"</Typography>
                        <Typography align="center" className="txt-home1">Escolhemos criar uma rede social com o objetivo de atender a Meta 3.4 da ODS 3:</Typography>
                        <Typography align="center" className="txt-home1">Até 2030, reduzir em um terço a mortalidade prematura por doenças não transmissíveis via prevenção e tratamento, promover a saúde mental e o bem-estar, a saúde do trabalhador e da trabalhadora, e prevenir o suicídio, alterando significativamente a tendência de aumento.</Typography>
                    </Box>
                </Grid>
            </Grid>
            <Divider />
                ...
                <Grid item xs={12} sm={4}>
                    ...
                    <Box mx={4}>
                        <Typography align="center">
                            A falta de acesso de grande parte da população a saúde mental contribui para o aumento de casos de transtornos e doenças mentais sem tratamento adequado, elevando a taxa de mortalidade por suicídio.
                        </Typography>
                    </Box>
                </Grid>
                <Grid item xs={12} sm={4}>
                    ...
                    <Box mx={4}>
                        <Typography align="center">
                            Por isso criamos a rede social Mentalize que facilita e promove o acesso da população a profissionais especializados.
                        </Typography>
                    </Box>
                </Grid>
                <Grid item xs={12} sm={4}>
                    ...
                    <Box mx={4}>
                        <Typography align="center">
                            Conectamos pessoas que precisam de apoio psicológico com profissionais da área dispostos a ajudar essas pessoas de forma gratuita, promovendo saúde e bem-estar para a população brasileira.
                        </Typography>
                    </Box>
                </Grid>
            </Grid>
